...
$string .="\n\n    // datatables
    function json() {
        ...
        \$this->datatables->add_column('action', anchor(site_url('".$c_url."/read/\$1'),'<i class=\"fa fa-eye\" aria-hidden=\"true\"></i>', array('class' => 'btn btn-success btn-sm')).\" 
            \".anchor(site_url('".$c_url."/update/\$1'),'<i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\"></i>', array('class' => 'btn btn-primary btn-sm')).\" 
